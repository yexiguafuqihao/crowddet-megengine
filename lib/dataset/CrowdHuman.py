...
class CrowdHuman(VisionDataset, Collator):
    ...
    def merge_batch(self, data):
        ...
        images = resized_images.astype(np.float32)
        ...
        ground_truth = np.stack(ground_truth, axis=1).astype(np.float32)
